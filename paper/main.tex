...
\subsection{The selected Origami fold patterns}
...
The Yoshimura pattern comes from the study of thin cylindrical shells under compression. It has a diamond-like folding pattern and was later used as a deliberate folding structure~\cite{Yoshimura1955}. 

Kresling is another fold pattern that produces both rotation and shortening when it is compressed. It can also have different stable folded and deployed states~\cite{Kresling2008}.
